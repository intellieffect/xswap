...
```sh
uv tool install 'git+https://github.com/intellieffect/xswap.git@v0.9.0'
xswap --version
```
...
<details>
<summary>What non-interactive commands do once <code>codex</code> is connected</summary>
...
```sh
uv tool install --force 'git+https://github.com/intellieffect/xswap.git@v0.9.0'
```
...
How the code is laid out — the neutral core, the provider boundary, and how to add a second platform — is in [docs/architecture.md](docs/architecture.md).

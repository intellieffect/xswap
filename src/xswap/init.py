...
def _step_auto(manager, args, ask, interactive, lines):
    from xswap.codex_cli import enable, read_settings
...
def _step_policy(manager, args, ask, interactive, lines):
    from xswap.codex_cli import read_settings, set_policy
...
def run_init(manager, args, ask=None, interactive=None):
    ...
    from xswap.doctor import print_report, run as run_doctor

...
import shutil  # noqa: F401  patch target: xswap.codex_cli.shutil.rmtree (runs.scan_runs prunes through it)
import shlex
import signal
import sys
import tempfile
...
from xswap.live import BRIDGE_LOG_NAME, AccountPool, Bridge, LiveError
from xswap.errors import BusyThreadError
from xswap.paths import ROOT_VARIABLE, auto_dir, cli_runs_dir
...
from xswap.settings import read_settings  # noqa: F401
from xswap.wrapper import (  # noqa: F401
...
from xswap.runs import (  # noqa: F401

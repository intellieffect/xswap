...
from xswap.live import BRIDGE_LOG_NAME
from xswap.paths import auto_dir, cli_runs_dir
from xswap.settings import read_settings
from xswap.wrapper import BYPASS_REASON, RELATIVE_ENTRY_REASON, bypass_set, wrapper_drift, wrapper_state
...
def reopen_command(session, state, manager):
    ...
    # `patch('xswap.codex_cli.saved_thread')` biting here.
